...
Task 5: complete (web bridge/view implementation; tests: `pytest tests/test_web_bridge.py tests/test_web_equipment.py tests/test_ui_equipment.py -q` -> 25 passed; `node --check web/app.js`, ruff, and diff check passed). Bundle regeneration is deferred to Task 6.
