...
class EditorView(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.stash_button = action_button(tr("ТАЙНИКИ"), self.inventory_column)
        self.stash_button.setToolTip(tr("Забрать предметы из тайников на локациях"))
        self.stash_button.setVisible(False)
        self.stash_button.clicked.connect(self.stash_requested)
        inventory_header.addWidget(self.stash_button)
    ...
    def set_snapshot(self, snapshot: Any) -> None:
        ...
        self.stash_button.setVisible(bool(snapshot.capabilities.add_items and getattr(snapshot.info, "stashes", ())))
