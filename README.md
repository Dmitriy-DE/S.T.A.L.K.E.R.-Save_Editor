...
- В верхней панели Qt и web есть компактная кнопка `♡ Support project`: она
  открывает локальное окно с реквизитами и копированием значений, без платёжных
  API, аккаунтов, аналитики и перенаправления на провайдера.
