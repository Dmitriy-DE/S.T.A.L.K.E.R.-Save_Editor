...
## M07 — чтение Call of Pripyat — 2026-09-15

M07 проверена как зависимая карточка и оставлена `blocked` в [PR #54](https://github.com/Dmitriy-DE/S.T.A.L.K.E.R.-2-HoC---Save_Editor/pull/54): M06 не принята,
реального CoP корпуса нет, а значит нет принятого контейнера, трёх независимых
пар на поле и сверки с игрой. В [M07 evidence](evidence/M07_COP_READ.md)
