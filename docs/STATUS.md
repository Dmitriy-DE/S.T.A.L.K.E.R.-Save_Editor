...
2026-09-13: U06 принята PR #43, B01 принят по коду PR #44, B02 ведёт текущую
acceptance matrix; см. [`docs/evidence/BETA_ACCEPTANCE.md`](evidence/BETA_ACCEPTANCE.md).
