# Состояние и пробелы — 2026-09-24
...
Локальный gate: `781 passed` (pytest в изолированном профиле), 14 Node tests,
...
Известные ограничения данных: у Call of Pripyat встроенный каталог собран с
английской локализацией и без имён большей части оружия (показывается ключ);
