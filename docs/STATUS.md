...
| Удобный UI | Tk/CLI и Qt используют общий service; Qt inventory search/filter и staged count работают локально, preview/apply/backup/cloud UI ещё не реализованы | U03–U06 |
