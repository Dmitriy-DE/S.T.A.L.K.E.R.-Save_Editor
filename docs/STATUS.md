...
| Удобный UI | Tk/CLI и Qt используют общий service; inventory search/filter, staged money/stack и preview/apply работают локально; backup browser/restore подключаются в U05, cloud UI остаётся U06 | U05–U06 |
