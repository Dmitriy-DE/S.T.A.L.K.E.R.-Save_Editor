...
- **S2: апгрейды и состояние.** Оружие без апгрейдов (Kharod, Сайга) теперь
  ...
  «Глушитель · ур. 3», «Экзоскелет · Монолит». Одиночные расходники, патроны и
  гранаты S2 можно менять по количеству. Запись апгрейдов S2 по-прежнему
  выключена: для неё нужен пересчёт размеров записи.
