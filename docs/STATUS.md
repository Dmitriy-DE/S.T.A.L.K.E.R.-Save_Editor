...
| Удобный UI | Tk/CLI и Qt используют общий service; inventory search/filter и staged money/stack работают локально, preview/apply подключены в U04, backup/cloud UI ещё не реализованы | U04–U06 |
