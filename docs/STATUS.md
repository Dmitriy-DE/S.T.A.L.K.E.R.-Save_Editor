...
| Удобный UI | Tk/CLI и Qt используют общий service; inventory search/filter, staged money/stack, preview/apply, backup browser/restore и Cloud tab работают локально; native DPI/Steam smoke остаются отдельными gates | U06, B01, B02 |
...
и clean-machine smoke статус B01 остаётся `in_progress`, а cross-platform beta
