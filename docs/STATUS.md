...
| Удобный UI | Tk и CLI используют общий UI-free service; Qt shell и удобные таблицы ещё не реализованы | U02–U06 |
