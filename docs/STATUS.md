...
S01 закрыта на ветке `task/s01`: переносимый synthetic fixture и 9 baseline-тестов добавлены; runtime не изменялся. Остальные строки ниже остаются открытыми и являются входом для S02–S06.
