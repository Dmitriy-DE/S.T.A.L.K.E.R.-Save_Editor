...
| Удобный UI | Tk/CLI и Qt используют общий service; inventory search/filter, staged money/stack, preview/apply и backup browser/restore работают локально; Cloud tab U06 в работе | U06 |
