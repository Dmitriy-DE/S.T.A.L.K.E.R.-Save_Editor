...
| [S02](S02.md) | Неизменяемый план правок и запрет опасного raw batch | S01 | in_progress | [#2](https://github.com/Dmitriy-DE/S.T.A.L.K.E.R.-2-HoC---Save_Editor/issues/2) |
