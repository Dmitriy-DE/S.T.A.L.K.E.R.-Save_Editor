...
| [M23](M23.md) | Безопасный X-Ray detach по известным registry-ссылкам | M20 | in_review (known parent-edge/equipped/unresolved preflight; full reference graph and game load pending) | — |
