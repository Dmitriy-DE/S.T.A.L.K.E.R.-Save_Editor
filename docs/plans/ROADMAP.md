...
- Новые возможности не считаются сделанными из-за наличия этого плана. Версия поднимается по фактически принятому результату; текущая — 0.4.2 (импортированный baseline был 0.3.0-experimental).
