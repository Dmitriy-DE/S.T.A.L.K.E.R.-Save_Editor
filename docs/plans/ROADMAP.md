...
| 8 — несколько игр | M01→M02→M03→M04→M05, отдельно M06→M07 | Реестр форматов, определение игры по содержимому, поиск Steam и папок сейвов, выбор слота; чужие форматы — только по evidence. [План](MULTI_GAME.md) |
