...
- Новые возможности не считаются сделанными из-за наличия этого плана. Версия поднимается по фактически принятому результату; текущая — 0.5.8 (импортированный baseline был 0.3.0-experimental).
